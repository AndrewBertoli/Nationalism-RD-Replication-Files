...
data=cbind(data,outcome,prevoutcome)
colnames(data)[colnames(data)=="outcome"]="Disputes_After"
colnames(data)[colnames(data)=="prevoutcome"]="Disputes_Before"

write.csv(data,"WorldCupDyads.csv",row.names=FALSE)
